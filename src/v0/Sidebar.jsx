        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-6 p-2 bg-black/20 rounded-md">
            ...
            <button
              ...
              className="text-white/60 hover:text-white transition-colors p-2 rounded-full hover:bg-zinc-800"
            >
        ...
        <div className="mt-2 p-4 border-t border-zinc-800 flex-1 flex flex-col">
          <div className="mb-3">
            <div className="flex items-center justify-between px-2 py-1">
              <h3 className={cn("text-sm font-medium text-white/60", !isOpen && "sr-only")}>
                Playlists
              </h3>
              {isOpen && (
                <button
